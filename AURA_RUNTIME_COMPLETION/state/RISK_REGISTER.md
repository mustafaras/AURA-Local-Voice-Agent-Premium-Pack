...
|---|---|---:|---:|---:|---|---|
| RISK-STATE-CONTRADICTION | Legacy state and handoff prose contains stale and contradictory completion claims. | R0 | High | High | Closed | Reconciled in BOOTSTRAP: legacy paths removed or migrated to `AURA_RUNTIME_COMPLETION/`, schemas validated, final scan shows no actionable stale references. Closure evidence: `EV-BOOTSTRAP-20260802-STATE-RECONCILE-01`, `EV-BOOTSTRAP-20260802-SCHEMA-VALIDATE-01`. Re-open if new stale pointers appear. |
