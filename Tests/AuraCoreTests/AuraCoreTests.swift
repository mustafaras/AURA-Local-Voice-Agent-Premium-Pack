...
struct AuraCoreTests {
  ...
  @Test func releaseTTSDefaultIsChatterboxFirstSystemFallback() {
    #expect(TTSAdapterChain().adapterIDs == ["chatterbox", "system"])
    #expect(TTSAdapterChain(adapterIDs: ["system"]).adapterIDs == ["system"])
  }
