...
| G1-4 | Auto-scroll: stick-to-bottom + jump-to-latest, honest (no scroll while user scrolled up) | blocked | SEQ-0023: implemented + view-pinned (AuraMenuView_Content.swift:340-437); live driver leg blocked by host lock screen (all AX queries time out / 0 windows; screenshot /tmp/aura-screen.png); bundle ready at /tmp/aura-ui1-app/AURA.app |
