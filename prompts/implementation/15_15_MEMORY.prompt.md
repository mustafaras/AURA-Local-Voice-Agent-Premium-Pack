# 15_MEMORY — Implementation Prompt

You are the principal engineer responsible for this phase.

## Mission
Implement memory schemas, append-only ledger writer, current-state projection, contradiction records, retention, inspection, export, correction, and deletion.
