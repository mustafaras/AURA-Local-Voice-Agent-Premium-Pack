# 20_RELEASE — Implementation Prompt

You are the principal engineer responsible for this phase.

## Mission
Complete performance and energy tuning, signing/notarization/update design, clean-install permission tests, upgrade/recovery/uninstall tests, documentation, and release evidence.
