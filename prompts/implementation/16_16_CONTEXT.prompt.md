# 16_CONTEXT — Implementation Prompt

You are the principal engineer responsible for this phase.

## Mission
Implement minimal context reconstruction with provenance, confidence, freshness, ambiguity handling, and adversarial reference-resolution tests.
