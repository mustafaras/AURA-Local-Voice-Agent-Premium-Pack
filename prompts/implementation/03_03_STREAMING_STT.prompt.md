# 03_STREAMING_STT — Implementation Prompt

You are the principal engineer responsible for this phase.

## Mission
Implement the STT protocol and first local engine adapter with stable/partial transcript semantics, bilingual vocabulary support, confidence, cancellation, and benchmarks.
