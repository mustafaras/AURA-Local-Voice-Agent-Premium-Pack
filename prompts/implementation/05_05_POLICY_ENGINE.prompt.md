# 05_POLICY_ENGINE — Implementation Prompt

You are the principal engineer responsible for this phase.

## Mission
Implement risk tiers, capabilities, scoped grants, confirmation binding, expiry, deny rules, audit events, and deterministic unit tests.
