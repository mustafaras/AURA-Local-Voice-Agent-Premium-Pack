# 11_CLAUDE_ADAPTER — Implementation Prompt

You are the principal engineer responsible for this phase.

## Mission
Implement the Claude Code or Agent SDK backend using verified current interfaces, permissions, hooks safety, session events, budgets, and integration tests.
