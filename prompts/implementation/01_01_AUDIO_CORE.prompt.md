# 01_AUDIO_CORE — Implementation Prompt

You are the principal engineer responsible for this phase.

## Mission
Implement the real-time-safe audio capture service, device management, ring buffer, timestamps, diagnostics, and privacy controls. Prove stability with unit, integration, and soak tests.
