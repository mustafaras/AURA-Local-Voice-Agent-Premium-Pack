# 10_CODEX_ADAPTER — Implementation Prompt

You are the principal engineer responsible for this phase.

## Mission
Implement the Codex backend using only verified current interfaces, explicit sandbox and approval mapping, structured events, budgets, cancellation, and integration tests.
