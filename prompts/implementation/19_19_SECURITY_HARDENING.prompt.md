# 19_SECURITY_HARDENING — Implementation Prompt

You are the principal engineer responsible for this phase.

## Mission
Complete threat models, injection defenses, secret handling, plugin verification, network/path allowlists, adversarial tests, and independent review.
