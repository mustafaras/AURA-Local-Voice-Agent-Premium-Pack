# 07_TYPED_SHELL — Implementation Prompt

You are the principal engineer responsible for this phase.

## Mission
Implement the typed process runner, command policy, PTY abstraction, redaction, timeout, cancellation, output bounds, and filesystem change evidence.
