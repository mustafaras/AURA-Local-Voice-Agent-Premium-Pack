# 08_VSCODE_ADAPTER — Implementation Prompt

You are the principal engineer responsible for this phase.

## Mission
Implement VS Code bundle, CLI, workspace, extension bridge, terminal, diagnostics, unsaved-file safety, and contract tests.
