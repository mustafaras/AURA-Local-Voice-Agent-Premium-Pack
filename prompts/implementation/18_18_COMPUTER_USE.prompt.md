# 18_COMPUTER_USE — Implementation Prompt

You are the principal engineer responsible for this phase.

## Mission
Implement bounded observe-plan-policy-act-verify loops, accessibility anchoring, emergency stop, no-progress detection, and destructive-action blocking.
