# 13_OLLAMA_ADAPTER — Implementation Prompt

You are the principal engineer responsible for this phase.

## Mission
Implement the Ollama model registry, capability routing, structured-output validation, lifecycle, memory budget, health, and degraded mode.
