# 00_BOOTSTRAP — Implementation Prompt

You are the principal engineer responsible for this phase.

## Mission
Create the repository foundation, workspace, build targets, typed configuration, event envelopes, logging, database migrations, test targets, CI, and ledger integration. Do not implement product features yet.
